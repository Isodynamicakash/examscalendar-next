"use client";
/**
 * Test-taking page (Phase 3).  /test?id=xxx
 *
 ...
 *   - Submit -> grades everything, writes results, goes to /test/report?id=xxx
 *
...
export default function TestPage() {
  ...
  const doSubmit = async (auto = false) => {
    ...
    try {
      ...
      router.replace(`/test/report?id=${id}`);
    } catch (e) {
