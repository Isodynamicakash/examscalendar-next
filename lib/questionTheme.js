...
// borders, near-white text. LIGHT mode kept identical to the original
// (previous edits had darkened it unnecessarily). Added `dropShadow`
// key to both modes since ChapterOverview.jsx references it.
...
export const DARK = {
  ...
  text: "#ffffff", textMuted: "#e5e5fa", textDim: "#9a9ac0",
